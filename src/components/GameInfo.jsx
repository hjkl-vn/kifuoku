...
export default function GameInfo({ gameInfo }) {
  ...
  return (
    <div className={styles.container}>
      {gameInfo.gameName && (
        <div className={styles.gameName}>{gameInfo.gameName}</div>
      )}
        ...
        <div className={styles.players}>
          {gameInfo.blackPlayer && (
            <div className={styles.player}>
              ...
              {gameInfo.blackRank && (
                <span className={styles.rank}>{gameInfo.blackRank}</span>
              )}
            </div>
          )}
          {gameInfo.whitePlayer && (
            <div className={styles.player}>
              ...
              {gameInfo.whiteRank && (
                <span className={styles.rank}>{gameInfo.whiteRank}</span>
              )}
            </div>
          )}
        </div>
